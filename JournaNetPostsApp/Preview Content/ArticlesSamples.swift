//
//  ArticlesSamples.swift
//  JournaNetPostsApp
//
//  Created by Hakob Ghlijyan on 06.09.2024.
//
    ...
    static var sampleArticles: [ArticlesModel] {
        [
            ...
            ArticlesModel(
                ...
                acticleText: "Twenty years after Germany's victory in World War II, while the entire country prepares for the U.S. president's visit, Berlin Detective Xavier March attempts to solve the murder of a high-ranking Nazi commander. Reprint.",
                dateCreated: .now
            ),
            ArticlesModel(
                ...
                acticleText: "Inheriting Ian Fleming's long-lost account of his spy activities during World War II, young American academic Amy Greenberg finds herself targeted by unknown assailants and must race to finish the manuscript in order to save her life and reveal the actions of a traitor.",
                dateCreated: .now
            ),
            ArticlesModel(
            ...
            ArticlesModel(
                ...
                status: "Writing",
                publisher: "Post in CNN",
                acticleText: "In London, during World War II, a dog uncovers a severed arm, which turns out to be that of a rocket scientist--and it was not a bomb that killed him. Sgt. Frederick Troy of Scotland Yard is assigned to the case, which pits him against the U.S. Office of Strategic Services, the wartime spy agency.",
                dateCreated: .now
            ),
            ArticlesModel(
                titleCategory: "golf",
